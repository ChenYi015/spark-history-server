...
*/}}
{{- define "spark-history-server.serviceAccount.name" -}}
...
*/}}
{{- define "spark-history-server.configMap.name" }}
{{- include "spark-history-server.fullname" . }}-conf
{{- end -}}

{{/*
Create the name of the secret to be used by spark history server.
*/}}
{{- define "spark-history-server.secret.name" }}
{{- include "spark-history-server.fullname" . }}-secret
{{- end -}}

{{/*
Create the name of the service to be used by spark history server.
*/}}
{{- define "spark-history-server.service.name" }}
{{- include "spark-history-server.fullname" . }}
{{- end -}}

{{/*
Create the name of the ingress to be used by spark history server.
*/}}
{{- define "spark-history-server.ingress.name" }}
{{- include "spark-history-server.fullname" . }}
{{- end -}}
